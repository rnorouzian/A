...
d2f <- function(d, n1=300, n2=300) sqrt(d2peta(d, n1, n2) / (1 - d2peta(d, n1, n2) ))
f2d <- function(f, n1=300, n2=300) peta2d(f2peta(f), n1, n2)                  
...
family_wise <- function(alpha, c) 1 - (1-alpha)^c                 
